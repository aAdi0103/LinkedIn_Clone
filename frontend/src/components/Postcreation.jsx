		...
		<div className='bg-white rounded-lg shadow mb-4 p-4'>
			<div className='flex space-x-3'>
				...
				<textarea
					...
					className='w-full p-2 rounded-lg bg-base-100 hover:bg-base-200 focus:bg-base-200 focus:outline-none resize-none transition-colors duration-200 min-h-[6vh] border-2'
					value={content}
