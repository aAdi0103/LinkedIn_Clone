...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
	...
	const { data: connectionStatus, refetch: refetchConnectionStatus } = useQuery({
		...
		queryFn: () => axiosInstance.get(`/connectionRequest/status/${userData._id}`),
	...
	const { mutate: sendConnectionRequest } = useMutation({
		mutationFn: (userId) => axiosInstance.post(`/connectionRequest/request/${userId}`),
		onSuccess: () => {
	...
	const { mutate: acceptRequest } = useMutation({
		mutationFn: (requestId) => axiosInstance.put(`/connectionRequest/accept/${requestId}`),
		onSuccess: () => {
	...
	const { mutate: rejectRequest } = useMutation({
		mutationFn: (requestId) => axiosInstance.put(`/connectionRequest/reject/${requestId}`),
		onSuccess: () => {
	...
	const { mutate: removeConnection } = useMutation({
		mutationFn: (userId) => axiosInstance.delete(`/connectionRequest/${userId}`),
		onSuccess: () => {
