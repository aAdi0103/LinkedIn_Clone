...
const LoginPage = () => {
	return (
		<div className='min-h-screen flex flex-col justify-center sm:px-6 lg:px-8'>
			<div className='sm:mx-auto sm:w-full sm:max-w-md mt-[-23vh]'>
				<img className='mx-auto h-32 w-auto' src='/logo.svg' alt='LinkedIn' />
				<h2 className=' text-center text-3xl mt-[-35px] font-extrabold text-gray-900'>Sign in to your account</h2>
			</div>
